...
const Community = () => {
  const socialLinks = [
    ...
    },
    {
      ...
      emoji: "👥",
      url: "https://x.com/i/communities/1935188067452932308"
    }
  ];
            ...
            <div key={index} className="group">
              <div className="bg-black/40 backdrop-blur-md rounded-2xl p-8 border border-orange-500/30 hover:border-yellow-400/50 transition-all duration-300 transform hover:scale-105 text-center">
                ...
                <a 
                  ...
                  className={`bg-gradient-to-r ${social.color} hover:opacity-90 text-white px-6 py-3 rounded-full font-bold transition-all duration-300 transform group-hover:scale-105 inline-block`}
                >
                  Join Now
                </a>
              </div>
